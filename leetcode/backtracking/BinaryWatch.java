...
public class BinaryWatch{
   ...
   // ["0:03","0:05","0:06","0:09","0:10","0:12","0:17","0:18","0:20","0:24","0:33","0:34","0:36","0:40","0:48","1:01","1:02","1:04","1:08","1:16","1:32","2:01","2:02","2:04","2:08","2:16","2:32","3:00","4:01","4:02","4:04","4:08","4:16","4:32","5:00","6:00","8:01","8:02","8:04","8:08","8:16","8:32","9:00","10:00"]
    ...
    public static void binaryWatch(boolean[]arr,int start,int counter,int k,List<String> ans){
        if(counter==k+1){
            if(getTimeFromArray(arr).length()>0) ans.add(getTimeFromArray(arr));
            
            return ;
        }
        for(int i=start;i<arr.length;i++){
            arr[i]=true;
            binaryWatch(arr, i+1,counter+1,k,ans);
            arr[i]=false;
